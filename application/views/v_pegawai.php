	...
	<body>
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
                                    ...
                                    <a href="<?php echo base_url();?>index.php/pegawai/cetak/" target="_blank" role="button" class="btn btn-yellow"> Cetak PDF </a>
						...
						<div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
                                                                    ...
                                                                    <tr class="odd">
                                                                                    ...
                                                                                    <td class="center"><?php echo $row->no_pegawai?></td>
											...
											<td class="td-actions ">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green btn_edit" href="#"
                                                                                                                    data-no_pegawai="<?php echo $row->no_pegawai;?>"
		...
		<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-small btn-inverse">
			<i class="icon-double-angle-up icon-only bigger-110"></i>
                ...
                <form name="modal_form1" method="post" action="<?php echo base_url(); ?>index.php/pegawai/simpan" enctype="multipart/form-data">
                <div id="modal-form" class="modal hide" tabindex="-1">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="blue bigger">Tambah Data Pegawai</h4>
								</div>
									...
									<div class="row-fluid">
										...
										<div class="span7">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span20" name="no_pegawai" id="no_pegawai" placeholder="NIP"/>
												</div>
											</div>
												...
												<div class="controls">
													<input type="text" class="span20" name="nama_pegawai" id="nama_pegawai" placeholder="Nama Pegawai"/>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span20" name="alamat" id="alamat" placeholder="Alamat"/>
												</div>
											</div>
                                                                                        <div class="control-group">
												<label class="control-label">Jenis Kelamin</label>
												<div class="controls">
													<input type="text" class="span20" name="jenis_kelamin" id="jenis_kelamin" placeholder="Jenis Kelamin"/>
												</div>
											</div>
										</div>
									</div>
                ...
                <form name="modal_form2" method="post" action="<?php echo base_url(); ?>index.php/pegawai/ubah/" enctype="multipart/form-data">
                <div id="modal-form2" class="modal hide" tabindex="-1">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="blue bigger">Ubah Data Pegawai</h4>
								</div>
									...
									<div class="row-fluid">
										...
										<div class="span7">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span20 no_pegawai" name="no_pegawai" id="no_pegawai" placeholder="NIP"/>
												</div>
											</div>
												...
												<label class="control-label">Nama Pegawai</label>
												<div class="controls">
													<input type="text" class="span20 nama_pegawai" name="nama_pegawai" id="nama_pegawai" placeholder="Nama Pegawai"/>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<label class="control-label">Alamat</label>
												<div class="controls">
													<input type="text" class="span20 alamat" name="alamat" id="alamat" placeholder="Alamat"/>
												</div>
											</div>
                                                                                        <div class="control-group">
												<label class="control-label">Jenis Kelamin</label>
												<div class="controls">
													<input type="text" class="span20 jenis_kelamin" name="jenis_kelamin" id="jenis_kelamin" placeholder="Jenis Kelamin"/>
												</div>
											</div>
										</div>
									</div>
